...
import { entryTemplatestyle as entryTemplate_style } from "../../../templates/entryTemplate.style";

export const NewMemory = ({ navigation, entryData, pickerDisplayDate, writeToFirebase }) => {
